    ...
    return (
      <SplashContainer>
        <div className="inner">
          ...
          <PromoSection>
            <Button href="/demo">Check out demo</Button>
            <Button href={docUrl('installation')}>Documentation</Button>
            <Button href="/blog">Changelog</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
    ...
    const Features = () => (
      <Block layout="fourColumn">
        {[
          {
            content:
              `Documentation will help you to understand how to use FBAC library on your next project.

[Go to documentation](${docUrl('installation')})`,
            image: `${baseUrl}img/icon-serp.svg`,
            imageAlign: 'top',
